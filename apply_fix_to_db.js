...
const dbPath = path.join(__dirname, 'buddhist.db');
...
if (info.changes > 0) {
  console.log('Successfully updated the database with fixed KaTeX content.');
} else {
  console.log('Failed to find the essay with the specified ID.');
}
